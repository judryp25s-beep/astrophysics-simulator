public class Main {
    ...
    public static void creerSystemeSolaire(Espace e) {
        ...
        for (int i = 0; i < distances.length; i++) {
            ...
            e.ajouterAstre(noms[i], "White", "Planet", 100, 8, 8, 0, 0, 0, v, 0, 0, distances[i]);
        }
    }
    ...
    public static void creerSystemeBistellaire(Espace e) {
        ...
        e.ajouterAstre("Soleil A", "Yellow", "Plane", MSoleil, 30, 30, 0, 0, 0, v, 0, 0, dist);
        e.ajouterAstre("Soleil B", "Orange", "Planet", MSoleil, 30, 30, 0, 0, 0, -v, 0, 0, dist);
    }
    ...
    public static void creerSystemeTristellaire(Espace e) {
        ...
        // Étoile 1 (Haut)
        e.ajouterAstre("Alpha", "Cyan", "Star", MSoleil, 25, 25, 0, 0, 0, v, 0, 0, rayon);
        // Étoile 2 (Bas Astre.Gauche)
        e.ajouterAstre("Beta", "White", "BlackHole",MSoleil, 25, 25, 0, 0, 0, -v/2, v, 130, 75);
        // Étoile 3 (Bas Droite)
        e.ajouterAstre("Astre.Gamma", "Red", "Star", MSoleil, 25, 25, 0, 0, 0, 0, -v, 130, -75);
    }
    ...
    public static void creerCasVitesses(Espace e) {
        ...
        e.ajouterAstre("Crash", "Red", "Star", 10, 6, 6, 0, 0, 0, vOrbite * 0.4, 0, 0, d);

        // 2. ORBITE : Vitesse parfaite (cercle)
        e.ajouterAstre("Orbite", "Astre.Green", "Star", 10, 6, 6, 0, 0, 0, vOrbite, 0, 0, d);

        // 3. LIBÉRATION : Vitesse trop haute (s'échappe en parabole)
        e.ajouterAstre("Evasion", "Blue", "Star", 10, 6, 6, 0, 0, 0, vLibre * 1.1, 0, 0, d);
    }
}